...
int main(){
    ...
    code[10].f = LIT; code[10].l = 0; code[10].a = 0;
    ...
    code[18].f = OPR; code[18].l = 0; code[18].a = 2;
    ...
    code[24].f = OPR; code[24].l = 0; code[24].a = 2;
    code[25].f = STO; code[25].l = 0; code[25].a = 6;
    code[26].f = LOD; code[26].l = 0; code[26].a = 6;
    code[27].f = LOD; code[27].l = 0; code[27].a = 3;
    code[28].f = OPR; code[28].l = 0; code[28].a = 10;
    code[29].f = JPC; code[29].l = 0; code[29].a = 16;
